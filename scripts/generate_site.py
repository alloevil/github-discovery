...
def generate_index_html(reports: list[tuple[str, list[dict]]]) -> str:
    ...
    <table class="wrapper" width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td width="100%">
          <table width="100%" cellpadding="20" cellspacing="0" border="0" align="center" style="max-width:960px; margin:0 auto;">
            <tr>
...
<body>
  ...
  <table class="top-bar" width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td width="100%">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" style="max-width:960px; margin:0 auto;">
          <tr>
            <td>
              <p>
