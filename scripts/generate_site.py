  ...
  <main class="page-body">
    <div class="container">
      ...
      <div class="subscribe-box">
        ...
        <a href="https://github.com/alloevil/github-discovery/issues/1" target="_blank" class="subscribe-btn-link">Subscribe via GitHub Issue →</a>
        <div class="subscribe-hint">Leave your email in the issue comments to subscribe. Free, no spam.</div>
      </div>
      <div class="date-nav">
{date_tabs}      </div>
