...
def generate_index_html(reports: list[tuple[str, list[dict]]]) -> str:
    ...
    <table class="wrapper" width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td width="100%">
          <table width="100%" cellpadding="20" cellspacing="0" border="0" align="center" style="max-width:1100px; margin:0 auto;">
            <tr>
...
<head>
  ...
  <style>
    * {{ margin: 0; padding: 0; box-sizing: border-box; }}
    ...
    /* Stats bar */
    .stats-bar {{ display: flex; justify-content: center; gap: 40px; padding: 20px; }}
    ...
    @media (min-width: 1200px) {{
      .wrapper > tbody > tr > td > table {{ max-width: 1100px; }}
    }}
...
<body>
  ...
  <table class="top-bar" width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td width="100%">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" style="max-width:1100px; margin:0 auto;">
          <tr>
            <td>
              <p>
  ...
  <table class="wrapper" width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td width="100%">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" style="max-width:1100px; margin:0 auto;">
          <tr>
            <td class="cross-promotion" width="100%">
